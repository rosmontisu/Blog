...
- **[GPU Performance for Game Artists (FragmentBuffer)](https://fragmentbuffer.com/gpu-performance-for-game-artists/)**
  - 렌더링 파이프라인(Draw Call, Vertex/Pixel Shader)과 메모리 대역폭이 실제 게임 에셋(Mesh, Texture)에 어떤 방식으로 병목을 일으키는지 상세히 풀어낸 아티클입니다.